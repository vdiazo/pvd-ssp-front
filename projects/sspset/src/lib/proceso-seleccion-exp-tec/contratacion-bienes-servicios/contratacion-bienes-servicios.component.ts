...
import { AplicarTipoControl, TipoObjeto } from '../../../appSettings/enumeraciones';
import { Funciones as Functions } from '../../../appSettings/funciones';


@Component({
  selector: 'set-contratacion-bienes-servicios',
...
export class ContratacionBienesServiciosComponent implements OnInit {
  ...
  cambiarPagina(pagina) {
    ...
    this.entidadBusqueda.numero_Pagina = ((pagina.page * 5) - 5); //(pagina.page * 5) - 4;   ----para el nuevo servicio
  ...
  busqueda(pagina) {
    ...
    this.entidadBusqueda.snip = this.snip == null ? 0 : this.snip;
    this.entidadBusqueda.tipo = TipoObjeto.BIENES_SERVICIOS;
    this.entidadBusqueda.numero_Pagina = ((pagina * 5) - 5);//(pagina * 5) - 4;   ----para el nuevo servicio->(pagina - 1) * 5
    this.entidadBusqueda.num_filas = 5;
    this.entidadBusqueda.codigo_unificado = this.codigo_unificado;
    this.entidadBusqueda.id_fase=this.idFase;
    this.consultarProcesoSeleccion(this.entidadBusqueda, this.idProyecto);
  ...
  openModalVerResultados(model) {
    ...
    model.idTramo = this.idTramo;// this.route.snapshot.params.idTramo;
    this.config = {
