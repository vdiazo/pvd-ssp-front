...
import { AplicarTipoControl } from '../../../../appSettings';
import * as fs from 'file-saver';
import { MaestraSsiService } from 'projects/sspssi/src/servicios/maestra-ssi.service';

@Component({
  selector: 'ssi-acciones-seguimiento-monitoreo',
...
export class AccionesSeguimientoMonitoreoComponent implements OnInit {
  ...
  descargarFormatoActaVisitaPDF() {
    ...
    this.fs.accionSeguimientoMonitoreoService.descargarFormatoActaVisitaPDF(idProyecto, idTramo, this.idSeguimientoMonitoreoObra)
      .subscribe((data: any) => {
