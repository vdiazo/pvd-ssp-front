...
//import { IValorizaciones, IEstadosSituacionales, IAdicionales, IAccionSegMonitoreo } from '../../../../../interfaces';
import { IValorizaciones, IAdicionales } from '../../../../../interfaces/IPeriodosValorizaciones';
import { IEstadosSituacionales } from '../../../../../interfaces/IEstadosSituacionales';
import { IAccionSegMonitoreo } from '../../../../../interfaces/IAccionSeguimientoMonitoreo';
...
export class ModalRegistrarComponent implements OnInit {
  ...
  crearForm(): void {
    ...
    if (this.seguimientoMonitoreoAccion.id_accion_seguimiento_monitoreo_obra > 0) {
      ...
      this.cambiarEstado(this.seguimientoMonitoreoAccion.id_estado_situacional, this.seguimientoMonitoreoAccion.periodo, this.seguimientoMonitoreoAccion.periodo_adicional);
