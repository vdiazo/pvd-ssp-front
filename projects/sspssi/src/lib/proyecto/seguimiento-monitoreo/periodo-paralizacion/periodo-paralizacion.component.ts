...
import { Functions, AplicarTipoControl } from '../../../../appSettings';
...
@Component({
  selector: 'ssi-periodo-paralizacion',
...
export class PeriodoParalizacionComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.monitoreo_tabSeg_obraValorizaciones_eliObraValorizaciones = this.esVisible("monitoreo_tabSeg_paralizacion_listParalizacion_listDetalleParalizacion")
  ...
  esVisible(hasClaimType) : boolean {
    hasClaimType = hasClaimType + "_" + this.tipoPerfil+"_eje_dir";
