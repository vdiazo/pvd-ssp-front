...
export class TransferenciaRealizadaMef {
    public id_transferencia: number;
    public id_transferencia_mef: number;
    public fecha_publicacion: Date | string;
    public fecha: Date | string;
    public dispositivo: string;
    public numero_proyectos: string;
    ...
    public _BE_Tm_Ssppvd_Transferencia_Mef: TransferenciaMaestra;
    public ListBE_Td_Ssppvd_Transferencia_Mef_Convenio: Array<TransferenciaConvenio> = [];
    public ListBE_Td_Ssppvd_Transferencia_Archivo: Array<TransferenciaArchivo> = [];
