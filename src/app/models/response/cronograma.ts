...

{
    ...
    */
    validarSeleccionesCronograma() : string {
        if (this.id_programa_ejecucion_financiera_obra == 0 ) return "Debe seleccionar el Programa de ejecución financiera.";
        if (this.id_documento_aprobacion_obra == 0 ) return "Debe seleccionar el Documento de aprobación de obra.";
        return "";
    }
