...
import { IBusquedaProyecto, IProyecto } from 'src/app/Interfaces';
...
export class WsConsultaPrincipalService {
  ...
  getProyecto(idProyecto: number,idTramo: number) {
    return this.http.get(Settings.API_ENDPOINT + "api/listarProyecto?id_proyecto=" + idProyecto + "&id_tramo=" + idTramo);
  }
  listarTipoFases() {
