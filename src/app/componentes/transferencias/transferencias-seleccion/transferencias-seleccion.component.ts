...
import { TransferenciasModalComponent } from './transferencias-modal/transferencias-modal.component';
import { FacadeService } from '../../../patterns/facade.service';
import { TransferenciaConvenioRequest } from '../../../models/request/transferencia-convenio-request';

@Component({
  selector: 'app-transferencias-seleccion',
  templateUrl: './transferencias-seleccion.component.html',
  styleUrls: ['./transferencias-seleccion.component.css']
})
export class TransferenciasSeleccionComponent implements OnInit {
  ...
  listarProyectos(pbeConvenioSeleccionarRequest: TransferenciaConvenioRequest) {
    this.fs.transferenciaRealizadaService.listadoConveniosRegistroTransferencia(pbeConvenioSeleccionarRequest).subscribe(
      respuesta => {
