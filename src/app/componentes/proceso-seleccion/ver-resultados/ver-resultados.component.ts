...
export class VerResultadosComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.beResultados = new Array<ProcesoSeleccionResultado>();
  ...
  consultaGarantiasInsertadas(pIdProyecto, pListGarantias) {
    this.servicio.listarGarantia(pIdProyecto).subscribe(
      (respuesta: any) => {
        this.listGarantiasInsertadas = respuesta;
  ...
  mergeGarantias(pListGarantias, pListGarantiasInsertadas) {
    ...
    //this.listGarantiasMerge=JSON.parse(JSON.stringify(pListGarantias));
    ...
    //           entidad_financiera:   pListGarantias[i].entidad_financiera ,
    //           fecha_registro: pListGarantias[i].fecha_registro ,
    //           tipo_entidad_financiera: pListGarantias[i].tipo_entidad_financiera ,
    //           tipo_garantia: pListGarantias[i].tipo_garantia 
    //         });
    //         break;
    //       } else {
    ...
    //             fecha_inicio: pListGarantiasInsertadas[j].fecha_inici,
    //             fecha_termino: pListGarantiasInsertadas[j].fecha_termino,
    //             //monto_garantia: this.funciones.format(this.funciones.setearValorDecimal(pListGarantiasInsertadas[j].monto_garantia.toString())),
    //             monto_garantia:pListGarantiasInsertadas[j].monto_garantia,
    //             url: pListGarantias[i].url,
