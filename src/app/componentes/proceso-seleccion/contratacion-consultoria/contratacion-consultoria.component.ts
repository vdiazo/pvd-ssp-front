...
@Component({
  selector: 'app-contratacion-consultoria',
  templateUrl: './contratacion-consultoria.component.html',
  styleUrls: ['./contratacion-consultoria.component.css']
})

export class ContratacionConsultoriaComponent implements OnInit {
  snip: number;
  idTramo: number;
  idFase: number;
  idTipoFase: number;
  ...
  ngOnInit() {
    ...
    this.habilitar = this.autService.hasClaim("monitoreo_tabSel_consultoria_modComentario") == AplicarTipoControl.Visible
    this.busqueda(1);
  ...
  consultarProcesoSeleccion(parametros: ProcesoSeleccionBienesServiciosRequest, pIdProyecto) {
    this.servicio.listarProcesoSeleccion(parametros).subscribe(
      data => {
        ...
        //this.lstCntConsultoriaCabecera = lstCntConsultoriaCabeceraReturn.data;
        this.lstCntConsultoriaCabecera = lstCntConsultoriaCabeceraReturn.resultado;
        //this.totalRegistros = lstCntConsultoriaCabeceraReturn.cantidad_registro;
  ...
  cambiarPagina(pagina) {
    ...
    this.entidadBusqueda.numero_Pagina = ((pagina.page * 10) - 10); //((pagina.page * 10) - 9);
  ...
  busqueda(pagina) {
    ...
    this.entidadBusqueda.snip = this.snip == null ? 0 : this.snip;
    this.entidadBusqueda.tipo = TipoObjeto.CONSULTORIA_OBRA;
    this.entidadBusqueda.numero_Pagina = ((pagina * 10) - 10); //((pagina * 10) - 9);
    this.entidadBusqueda.num_filas = 10;
    this.entidadBusqueda.codigo_unificado = this.codigo_unificado;
    this.entidadBusqueda.id_fase=this.idFase;
    this.consultarProcesoSeleccion(this.entidadBusqueda, this.idProyecto);
