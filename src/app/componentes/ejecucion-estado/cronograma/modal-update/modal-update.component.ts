...
export class ModalUpdateCronogramaComponent implements OnInit {
  ...
  //       sumaValorizacion = sumaValorizacion + valor;
  //     }
  //   });
  //   pcronograma.value.forEach(element => {
  //     if(element.valoracion_programada != ""){
  //       element.avance_programada = this.funciones.fixed(this.castToFloat(element.valoracion_programada) * 100 / sumaValorizacion,2);
  //     }else{
