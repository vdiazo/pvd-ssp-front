...
import { Functions, sessionStorageItems } from '../../../appSettings';
...
@Component({
  selector: 'app-resolucion-contrato',
...
export class ResolucionContratoComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    isNaN(this.idSeguimientoMonitoreoObra) || sessionStorage.getItem("fecha_inicio_obra") == "null" ? this.btnNuevo = true : this.btnNuevo = false;
